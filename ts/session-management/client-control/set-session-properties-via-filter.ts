...
export async function clientControlSetSessionPropertiesViaSessionFilter(): Promise<void> {
    /// tag::client_control_set_session_properties_via_session_filter[]
    ...
    await session1.clients.setSessionPropertiesByFilter(
        '$Principal is "client"',
        { '$Language': 'en-gb' }
    );
    ...
    /// end::client_control_set_session_properties_via_session_filter[]
}
