...
export async function clientControlChangeRolesViaSessionId(): Promise<void> {
    /// tag::client_control_change_roles_via_session_id[]
    ...
    /// end::client_control_change_roles_via_session_id[]
}
