...
export async function jsonPatchReplaceExample(): Promise<void> {
    /// tag::log
    const check = new PartiallyOrderedCheckpointTester([
        ...
        ['new value Fred: Flintstone', 'new value Barney: Rubble', 'new value George: Bedrock'],
        ['Closed'],
    ]);
    const valuePromise = promiseWithResolvers<void>();
    /// end::log
    /// tag::pub_sub_json_patch_replace[]
    ...
    /// end::pub_sub_json_patch_replace[]
    /// tag::log
    await check.done();
    /// end::log
}
