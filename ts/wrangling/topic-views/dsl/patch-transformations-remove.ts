...
export async function topicViewsDslPatchTransformationsRemove(): Promise<void> {
    /// tag::log
    const check = new PartiallyOrderedCheckpointTester([[
        'Subscribed to views/my/topic/path'
    ]]);
    /// end::log
    /// tag::topic_views_dsl_patch_transformations_remove[]
    ...
    /// end::topic_views_dsl_patch_transformations_remove[]
    /// tag::log
