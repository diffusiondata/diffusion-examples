...
namespace UCIStack.Examples
{
    ...
    public class ControlClientDynamicTopics
    {
        ...
        public ControlClientDynamicTopics()
        {
            ...
            // Add a handler that, upon receiving subscriptions or fetches for any topic under 'topicroot', creates
            // a topic.  If the topic name starts with 'SV', it creates a single value topic, otherwise a delegated
            // topic.
        ...
        {
            /// <summary>
            /// Notification that a context was closed prematurely, typically due to a timeout or the session being closed.
            /// No further calls will be made for a context.
            /// </summary>
