...
{
    public sealed class TrustClientProposedPropertyIn : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            WriteLine($"Trust client proposed property in.");

            string updateScript = session1.SystemAuthenticationControl.Script
                .TrustClientProposedPropertyIn("Flintstone", new List<string> { "Fred", "Wilma", "Pebbles" })
                .ToScript();
