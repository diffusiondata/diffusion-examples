...
{
    public sealed class AllowAnonymousConnections : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            WriteLine($"Allow anonymous connections.");
            ...
            WriteLine($"Session has been established for an anonymous principal.");
