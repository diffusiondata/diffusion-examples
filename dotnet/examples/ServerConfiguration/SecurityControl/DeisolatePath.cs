...
{
    public sealed class DeisolatePath : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            WriteLine($"Isolating my/topic/path permissions from parent and default path permissions.");

            string script = session.SecurityControl.Script.IsolatePath("my/topic/path").ToScript();
