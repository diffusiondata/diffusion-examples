...
{
    public sealed class AppendToTimeSeriesTopicViaUpdateStream : Example 
    {
        public override async Task Run( CancellationToken cancellationToken, string[] args ) 
        {
            ...
            var stream = builder.Build<double?>(topic);
            ...
            for (int i = 0; i < 25; i++)
            {
                ...
                await stream.SetAsync(newValue, cancellationToken);
            }
