...
{
    public sealed class SubscribeToTimeSeriesTopics : Example 
    {
        public override async Task Run( CancellationToken cancellationToken, string[] args ) 
        {
            ...
            string topicSelector = "?my/time/series//";
        ...
        private sealed class ValueStream : IValueStream<double?>
        {
            public void OnClose() {}
            ...
            {
                WriteLine($"{topicPath} changed from {(oldValue == null ? "NULL" : oldValue.ToString())} to {newValue}.");
            }
        }
    }
}
