...
{
    public sealed class PatchTransformationsMove : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1",
                                    "map ?my/topic/path// to views/<path(0)> patch '[ " +
                                        ...
                                        "{\"op\": \"move\", \"from\": \"/George\", \"path\": \"/The Jetsons~1George\" }]'", cancellationToken);
