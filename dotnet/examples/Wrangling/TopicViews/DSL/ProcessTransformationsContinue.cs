...
{
    public sealed class ProcessTransformationsContinue : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1", "map ?my/topic/path// to views/<path(3)> process {if '/price_per_share > 20' continue}", cancellationToken);
