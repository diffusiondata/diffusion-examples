...
{
    public sealed class ProcessTransformationsSet : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            string json2 = "{\"account\":\"5678\",\"balance\":{\"amount\":98.76,\"currency\":\"USD\"}}";
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1", "map ?my/topic/path// to views/<path(3)> process {if '/balance/amount > 20' set(/tier, 1) else set(/tier, 2)} process {set(/balance/amount_in_cents, calc '/balance/amount * 100')}", cancellationToken);
