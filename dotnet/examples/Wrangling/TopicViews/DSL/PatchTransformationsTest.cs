...
{
    public sealed class PatchTransformationsTest : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var view1 = await session.TopicViews.CreateTopicViewAsync("topic_view_1", "map ?my/topic/path// to views/<path(0)> patch '[{\"op\": \"test\", \"path\": \"/Fred\", \"value\": \"Flintstone\" }]'", cancellationToken);
