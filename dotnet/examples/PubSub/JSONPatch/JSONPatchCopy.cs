...
{
    public sealed class JSONPatchCopy : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var result = await session.TopicUpdate.ApplyJSONPatchAsync(topic, "[{\"op\":\"copy\", \"from\": \"/Meet the Flintstones/Fred\", \"path\": \"/The Jetsons/George\"}]", cancellationToken);

            WriteLine($"JSON patch copy has been successfully applied.");
