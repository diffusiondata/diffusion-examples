...
{
    public sealed class JSONPatchTest : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var result = await session.TopicUpdate.ApplyJSONPatchAsync(topic, "[{\"op\":\"test\", \"path\": \"/Fred\", \"value\": \"Flintstone\"}]", cancellationToken);

            WriteLine($"JSON patch test has been successfully applied.");
