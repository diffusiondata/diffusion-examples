...
{
    public sealed class JSONPatchReplace : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            var result = await session.TopicUpdate.ApplyJSONPatchAsync(topic, "[{\"op\":\"replace\", \"path\": \"/George\", \"value\": \"Bedrock\"}]", cancellationToken);

            WriteLine($"JSON patch replace has been successfully applied.");
