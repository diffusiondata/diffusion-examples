...
{
    public sealed class JSONPatchAdd : Example
    {
        public override async Task Run(CancellationToken cancellationToken, string[] args)
        {
            ...
            string json = "{\"Fred\":\"Flintstone\",\"Barney\":\"Rubble\"}";
            ...
            var result = await session.TopicUpdate.ApplyJSONPatchAsync(topic, "[{\"op\":\"add\", \"path\": \"/George\", \"value\": \"Jetson\"}]", cancellationToken);

            WriteLine($"JSON patch add has been successfully applied.");
