    ...
    public static class Program {
        ...
        public static void Main( string[] args ) {
            ...
            using ( var runner = new ExampleRunner() ) {
                ...
                /// Start System Authentication Control example
                //runner.Start(new SystemAuthenticationControl(), secureUrl);
                ...
                /// Start Security Control example
                //runner.Start(new SecurityControl(), secureUrl);

                /// Start Session Trees example
                //runner.Start(new SessionTrees(), secureUrl);

                /// Start Change Principal example
                //runner.Start(new ChangePrincipal(), secureUrl);

                /// Start Session Locks example
                //runner.Start(new SessionLocks(), secureUrl);

                /// Start Session Reconnection example
                //runner.Start(new SessionReconnection(), secureUrl);

                /// Start Session Metric Collector example
                //runner.Start(new SessionMetricCollector(), secureUrl);
