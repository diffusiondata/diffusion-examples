...
namespace PushTechnology.ClientInterface.Example.Consuming {
    /// <summary>
    /// Implementation of a client which subscribes to a binary topic and consumes the data it receives.
    /// </summary>
    public sealed class ConsumingBinaryTopics : IExample {
        /// <summary>
        /// Runs the binary topic consuming client example.
        /// </summary>
        ...
        public async Task Run( CancellationToken cancellationToken, string[] args ) {
            ...
            string topic = "random/Binary";

            // Add a topic stream for 'random/Binary'
            var binaryStream = new BinaryStream();
            topics.AddStream( topic, binaryStream );

            try {
                // Subscribe to 'random/Binary' topic
                ...
                topics.RemoveStream( binaryStream );
        ...
        /// <summary>
        /// Basic implementation of the IValueStream for binary topics.
        /// </summary>
        private sealed class BinaryStream : IValueStream<IBinary> {
            /// <summary>
            ...
            public void OnValue( string topicPath, ITopicSpecification specification, IBinary oldValue, IBinary newValue )
                => WriteLine( $"New value of topic '{topicPath}' is {Encoding.UTF8.GetString( newValue.ToByteArray() )}." );
        }
    }
}
