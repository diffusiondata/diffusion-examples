...
namespace PushTechnology.ClientInterface.Example.Consuming {
    /// <summary>
    /// Implementation of a client which subscribes to a integer topic and consumes the data it receives.
    /// </summary>
    public sealed class ConsumingIntegerTopics : IExample {
        /// <summary>
        /// Runs the integer topic client example.
        /// </summary>
        ...
        public async Task Run( CancellationToken cancellationToken, string[] args ) {
            ...
            // Add a topic stream for 'random/Integer'
            var integerStream = new IntegerStream();
            topics.AddStream( topic, integerStream );

            try {
                // Subscribe to 'random/Integer' topic
                ...
                topics.RemoveStream( integerStream );
        ...
        /// <summary>
        /// Basic implementation of the IValueStream for Integer topics.
        /// </summary>
        private sealed class IntegerStream : IValueStream<long?> {
            /// <summary>
