...
namespace PushTechnology.ClientInterface.Example.Publishing {
    ...
    /// </summary>
    public sealed class PublishingTimeSeriesAppend : IExample {
        /// <summary>
        ...
        public async Task Run( CancellationToken cancellationToken, string[] args ) {
            ...
            try
            {
                ...
                await session.TimeSeries.AppendAsync<String>(topicPath, "Value 2", cancellationToken);
                await session.TimeSeries.AppendAsync<String>(topicPath, "Value 3", cancellationToken);
                await session.TimeSeries.AppendAsync<String>(topicPath, "Value 4", cancellationToken);
