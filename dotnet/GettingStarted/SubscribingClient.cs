...
namespace UCIStack.GettingStarted
{
    ...
    internal class SubscribingClient
    {
        ...
        private class TopicStreamPrintLine : ITopicStream
        {
            ...
            /// This provides only <see cref="F:PushTechnology.ClientInterface.Client.Topics.TopicDetailsLevel.BASIC"/>details of the topic.
            /// </summary>
            ...
            /// </summary>
            /// <param name="topicPath">the full topic path.</param><param name="reason">the reason for unsubscription.</param>
            ...
            /// to.
            /// </summary>
            /// <param name="topicPath">the full topic path.</param><param name="content">the topic content. The context may contain more
            /// information about the nature of the content</param><param name="context">the update context which may indicate whether the
