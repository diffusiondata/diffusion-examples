...
public class TimeSeriesEditValueExample {
    ...
    public static void main(String[] args) {
        ...
        final TopicSpecification
            mySpec = Diffusion.newTopicSpecification(TopicType.TIME_SERIES)
            .withProperty(TopicSpecification.TIME_SERIES_EVENT_VALUE_TYPE, DOUBLE_DATATYPE_NAME)
            .withProperty(TopicSpecification.TIME_SERIES_RETAINED_RANGE, "limit 20 last 10s")
        ...
        timeSeries.edit(myTopicPath, 20, Double.class, 3.14).join();
