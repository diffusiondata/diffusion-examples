...
public class SessionTreesGetBranchMappingTableExample {
    ...
    private static final Logger LOG =
        LoggerFactory.getLogger(SessionTreesGetBranchMappingTableExample.class);
    ...
    public static void main(String[] args) {
        ...
        try (Session session = Diffusion.sessions()
            ...
            final SessionTrees.BranchMappingTable branchMappingTable1 = Diffusion.newBranchMappingTableBuilder()
            ...
            sessionTrees.putBranchMappingTable(branchMappingTable1)
                .join();
            ...
            sessionTrees.listSessionTreeBranchesWithMappings()
                ...
                .forEach(sessionTreeBranch -> {
                    ...
                    sessionTrees.getBranchMappingTable(sessionTreeBranch)
