...
public class RemoveTopicMetricCollectorExample {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(
        RemoveTopicMetricCollectorExample.class);
    ...
    public static void main(String[] args) {
        ...
        final String collectorName = topicMetricCollector.getName();

        metricsControl.putTopicMetricCollector(topicMetricCollector).join();
        metricsControl.removeTopicMetricCollector(collectorName).join();

        System.out.printf("%s has been removed", collectorName);
        session.close();

        LOG.info("Removed {}", collectorName);
    }
}
