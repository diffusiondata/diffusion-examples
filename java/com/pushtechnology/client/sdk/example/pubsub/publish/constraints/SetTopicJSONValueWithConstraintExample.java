...
import com.pushtechnology.diffusion.client.features.UpdateConstraint.Operator;
...
public class SetTopicJSONValueWithConstraintExample {
    ...
    private static final Logger LOG =
        LoggerFactory.getLogger(SetTopicJSONValueWithConstraintExample.class);
    ...
    public static void main(String[] args) {
        ...
        session.feature(TopicUpdate.class)
            .set("my/topic/path", JSON.class, differentValue, constraint).join();
        LOG.info("Topic updated");

        try {
            // attempt another constrained update, this will fail as the json
