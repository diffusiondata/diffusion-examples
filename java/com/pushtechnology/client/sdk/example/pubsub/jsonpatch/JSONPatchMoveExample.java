...
/**
 * This example demonstrates how to apply a JSON Patch to move a value within a
 * JSON topic in Diffusion.
 * <P>
 * The example creates a JSON topic, sets its initial value, and applies a JSON
 * Patch to move a field's value from one location to another within the JSON object.
 *
 * @author DiffusionData Limited
 */
public class JSONPatchMoveExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(JSONPatchMoveExample.class);
