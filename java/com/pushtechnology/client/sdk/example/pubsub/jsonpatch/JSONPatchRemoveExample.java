...
/**
 * This example demonstrates how to apply a JSON Patch to remove a value from a
 * JSON topic in Diffusion.
 * <P>
 * The example creates a JSON topic, sets its initial value, and applies a JSON
 * Patch to remove a specified field from the JSON object.
 *
 * @author DiffusionData Limited
 */
public class JSONPatchRemoveExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(JSONPatchRemoveExample.class);
