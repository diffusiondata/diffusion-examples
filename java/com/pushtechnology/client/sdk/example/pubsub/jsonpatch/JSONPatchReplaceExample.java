...
/**
 * This example demonstrates how to apply a JSON Patch to replace a value in a
 * JSON topic in Diffusion.
 * <P>
 * The example creates a JSON topic, sets its initial value, and applies a JSON
 * Patch to replace the value of a specified field within the JSON object.
 *
 * @author DiffusionData Limited
 */
public class JSONPatchReplaceExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(JSONPatchReplaceExample.class);
    ...
    public static void main(String[] args) {
        ...
        try (Session session = Diffusion.sessions()
            ...
            topicUpdate.applyJsonPatch(
                "my/topic/path",
                "[{\"op\":\"replace\", \"path\": \"/George\", \"value\": \"Bedrock\"}]"
            ).join();
