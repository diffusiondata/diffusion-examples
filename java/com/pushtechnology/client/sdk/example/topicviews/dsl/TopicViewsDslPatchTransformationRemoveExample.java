...
/**
 * This example demonstrates how to use the patch transformation to remove values within a JSON topic.
 * <P>
 * A topic view is created that applies a JSON Patch operation to remove a specific key from the
 * JSON content of the mapped topic.
 *
 * @author DiffusionData Limited
 */
public class TopicViewsDslPatchTransformationRemoveExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(TopicViewsDslPatchTransformationRemoveExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final TopicView view = topics.createTopicView("topic_view_1",
                "map ?my/topic/path// to views/<path(0)> patch '[{\"op\": \"remove\", \"path\": \"/George\"}]'")
            .join();
