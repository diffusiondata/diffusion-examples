...
/**
 * This example demonstrates how to use the patch transformation to add a new field to a JSON topic.
 * <P>
 * A topic view is created that applies a JSON Patch operation to add a new key-value pair
 * to the JSON content of the mapped topic.
 *
 * @author DiffusionData Limited
 */
public class TopicViewsDslPatchTransformationAddExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(TopicViewsDslPatchTransformationAddExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final JSON jsonValue = Diffusion.dataTypes().json()
            .fromJsonString("{\"Fred\":\"Flintstone\",\"Barney\":\"Rubble\"}");
        ...
        final TopicView view = topics.createTopicView("topic_view_1",
                "map ?my/topic/path// to views/<path(0)> " +
                    "patch '[{\"op\": \"add\", \"path\": \"/George\", \"value\": \"Jetson\"}]'")
            .join();
