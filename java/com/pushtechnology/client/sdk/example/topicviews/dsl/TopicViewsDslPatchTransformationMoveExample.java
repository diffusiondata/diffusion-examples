...
/**
 * This example demonstrates how to use the patch transformation to move values within a JSON topic.
 * <P>
 * A topic view is created that applies JSON Patch operations to move values from one key
 * to another within the JSON content of the mapped topic.
 *
 * @author DiffusionData Limited
 */
public class TopicViewsDslPatchTransformationMoveExample {

    private static final Logger LOG =
        LoggerFactory.getLogger(TopicViewsDslPatchTransformationMoveExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        final TopicView view = topics.createTopicView("topic_view_1",
                "map ?my/topic/path// to views/<path(0)> patch '[ " +
                    "{\"op\": \"move\", \"from\": \"/Fred\", \"path\": \"/Meet The Flintstones~1Fred\" }, " +
                    "{\"op\": \"move\", \"from\": \"/Barney\", \"path\": \"/Meet The Flintstones~1Barney\" }, " +
                    "{\"op\": \"move\", \"from\": \"/George\", \"path\": \"/The Jetsons~1George\" }]'")
            .join();
