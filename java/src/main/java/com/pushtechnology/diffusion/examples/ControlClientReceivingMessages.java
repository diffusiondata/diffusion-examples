...
public class ControlClientReceivingMessages {
    ...
    public ControlClientReceivingMessages(SendCallback callback) {
        ...
        // permission.
        echoingSessionMessagingControl.addMessageHandler("foo",
            new EchoHandler());
    }
        ...
        public void onMessage(
            ...
            try {
                final JSONObject jsonObject =
                    new JSONObject(content.asString());
                final String value = (String) jsonObject.get("hello");
                LOG.info(
                    "JSON content with key: 'hello' and value: '{}'",
                    value);
            }
    ...
    public void sendHelloWorld() {
        ...
        final JSON helloWorldJson = Diffusion.dataTypes().json()
            .fromJsonString("{\"hello\":\"world\"}");

        // To do this, the client session must have the 'view_session' and
        // 'send_to_session' permissions.
