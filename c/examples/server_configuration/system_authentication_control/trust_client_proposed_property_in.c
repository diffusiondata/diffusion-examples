    ...
    CREDENTIALS_T *credentials)
{
    ...
    SET_T *set_allowed_values = set_new_string(3);
    set_add(set_allowed_values, "Fred");
    set_add(set_allowed_values, "Wilma");
    set_add(set_allowed_values, "Pebbles");

    SCRIPT_T *script = script_create();
    update_auth_store_trust_client_proposed_property_in(
        script, "Flintstone", set_allowed_values
    );
    set_free(set_allowed_values);
    ...
    diffusion_session_factory_property(session_factory, "Flintstone", "Barney");
    ...
    diffusion_session_factory_property(session_factory, "Flintstone", "Fred");
