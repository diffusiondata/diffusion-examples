    ...
    CREDENTIALS_T *credentials)
{
    ...
    diffusion_remote_server_builder_retry_delay(builder, 250, NULL);

    LIST_T *urls = list_create();
    list_append_last(urls, "ws://localhost:8080");
    list_append_last(urls, "ws://localhost:8081");
    list_append_last(urls, "ws://localhost:8082");
