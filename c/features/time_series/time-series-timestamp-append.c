 ...
 * data to it with a user supplied timestamp.
 */
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
ARG_OPTS_T arg_opts[] = {
        ...
        {'t', "topic", "Topic name to create and update", ARG_OPTIONAL, ARG_HAS_VALUE, "time-series-timestamp-append"},
...
main(int argc, char** argv)
{
        ...
        while(time(NULL) < end_time) {
                ...
                /*
                 * Compose the timestamp value in milliseconds for the append
                 */
                const long time_previous_day_ms = (time_now - (24 * 60 * 60)) * 1000;

                DIFFUSION_TIME_SERIES_TIMESTAMP_APPEND_PARAMS_T params = {
                        .on_append = on_append,
                        .on_error = on_error,
                        .topic_path = topic_name,
                        .datatype = DATATYPE_STRING,
                        .value = value,
                        .timestamp = time_previous_day_ms
                };
