...
and select the `examples\android\pubsub` directory.
...
2. Create and/or start a virtual device, using API level 19 or higher.

3. Use Android Studio (`Run/Run "app"`) to deploy the example to the Android emulator. 

4. Updates to the 'counter' topic will be displayed on the virtual device UI.
