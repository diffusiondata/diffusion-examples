...
export async function subscribeTopicSelectionScopesExample() {
    /// tag::log
    ...
    const componentAStream = session.addStream('my/topic/path', diffusion.datatypes.string());
    const componentBStream = session.addStream('?my//', diffusion.datatypes.string());
