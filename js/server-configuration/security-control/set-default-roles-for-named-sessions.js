...
export async function securityControlSetDefaultRolesForNamedSessions() {
    ...
    const securityScript = session.security.securityScriptBuilder()
        .setRolesForNamedSessions([ 'ADMINISTRATOR' ])
        .build();
    console.log('All named sessions now have ADMINISTRATOR priviledges.');
    ...
    const securityScriptCleanup = session.security.securityScriptBuilder()
        .setRolesForNamedSessions([ 'CLIENT' ])
        .build();
