...
#import "TimeSeriesCreateTopicExample.h"

@import Diffusion;


@implementation TimeSeriesCreateTopicExample  {
...
-(void)startWithURL:(NSURL*)url {
    ...
    [PTDiffusionSession openWithURL:url
                  ...
                  completionHandler:^(PTDiffusionSession *const session, NSError *const error)
     {
         ...
         NSString *const topicPath = @"topic/timeseries/example";

         // create and populate the topic (Publisher)
